...
<head>
  ...
  <style>
    * {
    ...
    /* Floating Action Button (FAB) and toolbar */
    .btn-comment {
    ...
    [data-theme="light"] .task-header h4 {
      color: #1f2937;
    }
    ...
    <div class="content-wrapper">
      ...
      @if($cards->isEmpty())
        <div class="glass-card empty-state">
          ...
          <h4>No Design Tasks Assigned</h4>
          <p class="text-surface-muted">You don't have any design tasks assigned yet.</p>
        </div>
      @else
            ...
            <div class="task-card {{ $projectFinished ? 'task-card--project-finished' : '' }}"
              ...
              <div class="subtask-content" id="subtaskContent{{ $card->card_id }}">
                <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                  <h6 class="mb-0">🎨 Design Subtasks</h6>
          ...
          <div id="designerTaskSearchEmpty" class="glass-card empty-state text-center d-none">
            <i class="bi bi-search"></i>
