...
<head>
    ...
    <title>My Team - Developer Dashboard</title>
    ...
    <div class="main-content-area">
        ...
        <div class="content-wrapper">
            ...
            @if($projects->count() > 0)
                ...
                @endforeach
                <div id="developerTeamSearchEmpty" class="glass-card empty-state text-center d-none">
                    <i class="bi bi-search"></i>
            ...
            @else
                <div class="glass-card empty-state">
                    ...
                    <h4 class="text-gradient mt-3">No Dev Projects Yet</h4>
                    <p class="empty-project-text">You haven't joined any development projects yet.</p>
                </div>
            @endif
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const searchInput = document.getElementById('developerTeamSearch');
        const projectCards = document.querySelectorAll('.team-project-card');
        const emptyNotice = document.getElementById('developerTeamSearchEmpty');
